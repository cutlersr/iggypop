...
########     
        ...
        try:
            ...
            if codon_tbl == "cocoputs":
                # special-case arabidopsis → a_thaliana
                lookup_species = "a_thaliana" if species == "arabidopsis" else species

                codon_table, species_name, messages = calculate_codon_frequencies(
                    file_path='data/cleaned_coco.tsv',
                    species_identifier=lookup_species
                )
            else:
