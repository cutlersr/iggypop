...
def print_header_cds(tag):
    ...
    print("    ")
    print("          removes common gg enzyme sites (BsaI, BsmBI, BbsI)")
    print("          generates MoClo compatible CDSs (AATG/GCTT ends).")
    print("           - alter `base_5p_end` & `base_3p_end` to modify ends.`")
    print()
    print('    use:')
    print('       "--codon_opt" to set codon opt methods if desired')
    print('       "--species" to change codon table (default arabidosis)')
    ...
    print('       "--quiet on" to silence output')
    print('       "--reports on" for reports that illustrate sequence changes')
