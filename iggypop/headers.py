...
def print_header_cds(tag):
    ...
    print()
    print("    **the default yaml/moclo_cds.yml configuration file:")
    print("    ")
    ...
    print("          and generates MoClo compatible CDSs")
    print()
    print('    use:')
...
def print_header_format(tag):
    ...
    print("    the 'format' option, which uses a yaml file to set parameters.")
    print()
    print('-' * 80)
    print(f"{'Sean Cutler            cutler@ucr.edu            @cutlersr'.center(80)}")
    print()
    print(f"{'University of California, Riverside'.center(80)}")
    print('-' * 80)
    print()
